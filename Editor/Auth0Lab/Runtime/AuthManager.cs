...
namespace Auth0
{
    ...
    public sealed class AuthManager
    {
        ...
        private AuthManager()
        {
            ...
            {
                Domain = "futurefest-testing.us.auth0.com",
                ClientId = "3qQIdscE9SE1dWPhQRnesXgnJjzTahJJ",
                Scope = "openid profile ffclient:play",
                Audience = "https://testing-multiauth.futurefest.io"
            };
